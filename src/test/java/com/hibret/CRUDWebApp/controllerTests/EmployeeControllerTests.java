package com.hibret.CRUDWebApp.controllerTests;
...
public class EmployeeControllerTests {
    ...
    public void givenListOfEmployees_whenGetAllEmployees_thenReturnEmployeesList() throws Exception{
        ...
        listOfEmployees.add(Employee.builder().firstName("adonay").lastName("eshetu").emailId("ady@gmail.com").build());
        listOfEmployees.add(Employee.builder().firstName("haile").lastName("mekuria").emailId("haile@gmail.com").build());
